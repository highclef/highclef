...
public class ConnectionTestDB {
 ...
 public static void main(String[] args) {
  ...
  try {
   Class.forName("com.mysql.cj.jdbc.Driver");//드라이버 로딩: DriverManager에 등록
  }catch(ClassNotFoundException e) {
   System.err.print("ClassNotFoundException: ");
  }
  
  try {
   String jdbcUrl = "jdbc:mysql://localhost:3306/kEssen";//사용하는 데이터베이스명을 포함한 url
   String userId = "root";//사용자계정
   String userPass = "answldud93";//사용자 패스워드
